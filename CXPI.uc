//============================
class CXPI extends PlayerInput
	config(User)
	transient;
//============================

// CXPI - Custom XBOX PlayerInput
// V 1.0
// Child class of PlayerInput, not XBoxPlayerInput!!!!!!
// Turns out XBoxPlayerInput never gets used, the xbox still uses the default PlayerInput class...
// Copy all vars and properties from parent class to this one to fix the weird controller input!
...
// bind the X button to the keyboard command
function PostBeginPlay()
{
	ConsoleCommand("Set Input GameX openConsoleMenu");
	
	Super.PostBeginPlay();
}

//command to open our virtual keyboard to enter console commands
exec function openConsoleMenu()
{
